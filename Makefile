...
IMAGE_URL               := https://hub.docker.com/r/asaharan3/labels
IMAGE_SOURCE            := https://github.com/abhi1693/labels
IMAGE_LICENSES          := MIT
IMAGE_DOCUMENTATION     := https://github.com/abhi1693/mkdocs-material
