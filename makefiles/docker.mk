...
docker: ## Build docker image.
    ...
    --label io.github.abhi1693.build.system="$(IMAGE_BUILD_SYSTEM)" \
    --label io.github.abhi1693.build.host="$(IMAGE_BUILD_HOST)" \
    --label io.github.abhi1693.actions.workflow="$(GITHUB_WORKFLOW)" \
    --label io.github.abhi1693.actions.build="$(GITHUB_RUN_NUMBER)" \
    --label io.github.abhi1693.actions.actor="$(GITHUB_ACTOR)" \
    --label io.github.abhi1693.actions.ref="$(GITHUB_REF)" \
    --label io.github.abhi1693.git.commit="$(GIT_COMMIT)" \
    --label io.github.abhi1693.upstream.present="$(UPSTREAM_PRESENT)" \
    $(UPSTREAM_ARGS) \
